            ...
            <tr>
                ...
                <td width="25%" height="500px" valign="top" id="insides">
                    ...
                    <table border="0">
                        ...
                        <tr>
                            <td><img src="img/Picture2.png" width="10px">&nbsp;<a href="academic.php">Academic
                                    Calender</a></td>
                        </tr>
                        <tr>
                ...
                <td valign="top">
                    <br>
                    <br>
                    Debre Berhan University Location
                    <br>
                    <img src="img/site.png" width="630px" height="500px">
                </td>
            </tr>
        </table>
        <!--End Body of section-->
